...
<head>
    ...
    <style>
        ...
        .task-title { font-size: 13px; color: #5a7a9e; font-weight: 500; }
        ...
        .note-title { font-size: 13px; font-weight: 700; color: #b8963e; margin-bottom: 4px; }
        .note-body { font-size: 12px; color: #8a7a5a; line-height: 1.5; }
        .note-input {
            width: 100%;
        ...
        .empty-state { text-align: center; color: #aab4c8; font-size: 13px; padding: 1rem 0; }
    </style>
</head>
<body>
<div class="container-fluid py-4 px-3 px-md-5">
    ...
    <div class="text-center mb-4">
        <h1 style="font-size:24px; font-weight:700; color:#7b9abf;">🪼 my dashboard</h1>
